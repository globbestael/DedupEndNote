...
import edu.dedupendnote.unit.services.AuthorsBaseTest;
import lombok.extern.slf4j.Slf4j;

@Slf4j
@SpringBootTest
@ActiveProfiles("test")
class SimilarityAuthorTest extends AuthorsBaseTest {
	...
	AuthorsComparisonService authorsComparisonService;
