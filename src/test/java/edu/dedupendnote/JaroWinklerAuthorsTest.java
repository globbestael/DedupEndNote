...
class JaroWinklerAuthorsTest {
	...
	static Stream<Arguments> positiveAuthorsProvider() {
		return Stream.of(arguments("Ram, S; Lewis, LA; Rice, PA", "Ram, S.; Lewis, L. A.; Rice, P. A.", 1.0, 1.0),
				...
				arguments("Li, W.; Wang, Y.; Gao, W.; Zheng, J.",
						"Wei, Li; Yang, Wang; Wenfeng, Gao; Jiasheng, Zheng; Li, Wei; Wang, Yang; Gao, Wenfeng; Zheng, Jiasheng",
						0.63, 1.0),
				arguments("Li, W.; Wang, Y.; Gao, W.; Zheng, J.", "Wei, Li; Yang, Wang; Wenfeng, Gao; Jiasheng, Zheng",
						0.81, 1.0),
				arguments("Harned, R., 2nd",
				...
				arguments("Danilă, M.; Sporea, I.; Popescu, A.; şirli, R.",
						"Danila, M.; Sporea, I.; Popescu, A.; Sirli, R.", 0.99, 0.99), // diacriticals
				arguments("Lynch Jr, T. J.; Kalish, L.; Mentzer, S. J.; Decamp, M.; Strauss, G.; Sugarbaker, D. J.",
						"Lynch, T.; Kalish, L.; Mentzer, S.; Decamp, M.; Strauss, G.; Sugarbaker, D.", 0.99, 0.99), // different
																													// numbers
																													// of
																													// initials
				arguments("Lv, Y; Qi, X; Xia, J; Fan, D; Han, G", "Lv, Y; Qi, XS; Xia, JL; Fan, DM; Han, GH", 0.98,
						0.98), // when initials get form "JK" instead of "J. K.": 0.89 -->
								// 0.98
				arguments("Lv, Y.; Qi, X.; Xia, J.; Fan, D.; Han, G.",
						"Lv, Y.; Qi, X. S.; Xia, J. L.; Fan, D. M.; Han, G. H.", 0.98, 0.98),
				arguments("De Joode, E. A.; Van Heugten, C. M.; Verheij, F. R. J.; van Boxtel, M. P. J.",
						"Joode, E. A.; Heugten, C. M.; Verheij, F. R.; Boxtel, M. P.", 0.77, 0.97), // transposition
																									// of
																									// complex
																									// last
																									// names
				arguments("Joode, E. A. D.; Heugten, C. M. V.; Verheij, F. R. J.; Boxtel, M. P. J. V.",
						"Joode, E. A.; Heugten, C. M..; Verheij, F. R.; Boxtel, M. P.", 0.97, 0.97), // first
																										// part
																										// of
																										// first
																										// name
				...
				arguments(
						...
						"Heekeren, K.; Neukirch, A.; Daumann, J.; Stoll, M.; Obradovic, M.; Kovar, K. A.; Geyer, M. A.; Gouzoulis-Mayfrank, E.",
						0.82, 0.82), // Excample from McKeown (Ovid DB cctr: First is
										// compared as Heekeren K NADJSMOMKKAGMAGME
				arguments("DIMASCIO, R; MARCHIOLI, R; TOGNONI, G", "Di Mascio, R; Marchioli, R; Tognoni, G", 0.86,
						0.86), // ALL CAPITALS
				arguments("Tonni, G.; Grisolia, G.", "Gabriele, Tonni; Gianpaolo, Grisolia", 0.64, 0.64), // Transposed
																											// names
				arguments(
				...
				arguments(
						"Schwartzberg, L. S.; Tauer, K. W.; Schnell, F. M.; Hermann, R.; Rubin, P.; Christianson, D.; Weinstein, P.; Epperson, A.; Walker, M.",
						"Schwartzberg, L. S.; Blakely, L. J.; Schnell, F.; Christianson, D.; Andrews, M.; Johns, A.; Walker, M.",
						0.85, 0.85), // example of a false positive: 9 vs 7 names, 4 in
										// common
				arguments("Okuda, K.", "Okuda, K.; Orozco, H.; Garcia‐Tsao, G.; Takahashi, T.", 0.83, 0.83),
				arguments(
						...
						0.82, 0.82), // example of a false positive: 12 vs 9 names, 6 in
										// common
				arguments(
						"Adriana, Bintintan; Petru Adrian, Mircea; Romeo, Chira; Georgiana, Nagy; Roberta Manzat, Saplacan; Simona, Valean",
						"Bintintan, A.; Mircea, P. A.; Chira, R.; Nagy, G.; Saplacan, R. M.; Valean, S.", 0.71, 0.76), // 0.72
																														// //
																														// first
																														// and
																														// last
				...
				arguments("Bitto, N.; Tosetti, G.; La Mura, V.; Primignani, M.",
						"Scheiner, B.; Northup, P. G.; Lisman, T.; Mandorfer, M.", 0.68, 0.68), // 0.68
																								// //
																								// !!!
																								// despite
																								// big
																								...
																								// IN
																								// COMMON
				arguments("Agata, Mulak", "Mulak, A.", 0.52, 0.64),
				arguments(
	...
	static Stream<Arguments> negativeAuthorsProvider() {
		return Stream.of(arguments("Wilkinson, E. J.; Raab, S. S.", "Flowers, L. C.; Tadros, T. S.", 0.58),
				arguments("Bouros, Demosthenes", "Rosa, Ute W.", 0.61),
				arguments("Armentano, P.", "Clendenning, R.", 0.56),
				arguments("Carter, G. T.; Mirken, B.", "Finnerup, N. B.; Otto, M.; Jensen, T. S.; Sindrup, S. H.",
						0.51),
