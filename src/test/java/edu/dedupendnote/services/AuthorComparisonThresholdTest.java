...
import edu.dedupendnote.DedupEndNoteApplication;
...
class AuthorComparisonThresholdTest extends AuthorsBaseTest {
	...
	AuthorComparisonThresholdTest(ComparisonService comparisonService, DedupEndNoteApplication dedupEndNoteApplication,
