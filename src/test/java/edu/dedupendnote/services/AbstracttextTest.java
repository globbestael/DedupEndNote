	...
	static Stream<Arguments> positiveArgumentProvider() {
		return Stream.of(
				...
				arguments(
						...
						1.0),
				/*
				 * First string is from PubMed (PMID 34537006): char at position 149 is "\u2009" (THIN SPACE)
				 * Second string is from Cochrane (CN-02321497): char at position 149 is "\u0020" (SPACE), 
				 * but 68 and 83 are "\u2010" (HYPHEN) not "\u002D" (HYPHEN-MINUS)
				 */
				arguments(
