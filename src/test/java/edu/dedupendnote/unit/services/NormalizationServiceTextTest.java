...
class NormalizationServiceTextTest {
	...
	static Stream<Arguments> argumentProvider() {
		...
		return Stream.of(
				 ...
				 * BUT: BibliographicItemReader normalizes whitespace before BibliographicItem.normalizeToBasicLatin(), and pattern replaces them all with a normal space
				 */
				arguments(
					"\u0020,\u0085,\u00A0,\u1680,\u2000,\u2001,\u2002,\u2003,\u2004,\u2005,\u2006,\u2007,\u2008,\u2009,\u200A,\u2028,\u2029,\u202F,\u205F,\u3000",
					// BibliographicItem.normalizeToBasicLatin: only normal space is kept, rest are removed
					" ,,,,,,,,,,,,,,,,,,,",
